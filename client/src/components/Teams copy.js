...
function TeamCard() {
  ...
  return (
    <div className=" container">
       <div className=" mb-4 grid md:grid-cols-7 grid-cols-4 flex-wrap" >
<p>position</p>
<p>Team</p>
<p>Points</p>
<p>Games Played</p>
      ...
      {league
        ? league.map((teams, index) => (
            ...
            >
              ...
              <div className="statcolumn"> {teams.won}</div>
              <div className="statcolumn"> {teams.draw}</div>
              <div className="statcolumn"> {teams.lost}</div>
            </div>
          ))
        : "Loading"}
    </div>
